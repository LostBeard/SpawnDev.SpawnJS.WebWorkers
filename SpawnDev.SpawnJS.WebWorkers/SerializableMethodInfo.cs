...
namespace SpawnDev.SpawnJS.WebWorkers
{
    ...
    public class SerializableMethodInfo
    {
        ...
        {
            var ret = string.IsNullOrEmpty(json) || !json.StartsWith("{") ? null : JsonSerializer.Deserialize(json, WebWorkersJsonContext.Default.SerializableMethodInfo);
            return ret;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public override string ToString() => JsonSerializer.Serialize(this, WebWorkersJsonContext.Default.SerializableMethodInfo);
